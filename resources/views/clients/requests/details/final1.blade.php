...
@section('statistics')
	        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-right" style="font-family: b koodak;">جزئیات درخواست خدمت {{ $service->codepaygiry }}</div>
                                <div class="pull-left"><a href="<?=Url('client/final_service'); ?>" class="btn btn-danger" style="font-family: b koodak; margin-top: 0px; margin-bottom: 3px;">بازگشت</a>
                                </div>
                            </div>
                                            ...
                                            @foreach($details as $detail)
                                              <tr>
                                               ...
                                               @endif 
                                                ...
                                                <td style="font-family: b nazanin; text-align: center;">{!! getservname($detail-> services_id) !!}</td>
