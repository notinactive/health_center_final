...
@section('statistics')
	        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-right" style="font-family: b koodak;">لیست درخواست های کالای نهایی شده</div>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="gradeC" style="font-family: b koodak;">
                                                ...
                                                @if($product->cancel == '0' )
                                                <a href="#" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#delete{{ $product->id }}">ثبت انصراف</a>
                                                @elseif($product->cancel == '1')
                                                
                                                @endif                              
                                                    
                                                <a href="<?=Url('client/final2/'.$product->id); ?>" class="btn btn-info btn-sm btn-line">مشاهده جزئیات</a>
                                                </td>
                                                    @if( $product->cancel == '0' )
                                                        <td style="color: green; text-align: center;"> انصراف داده نشده</td>
                                                    @elseif( $product->cancel == '1' )
                                                        <td style="color: red; text-align: center;"> انصراف داده شده </td>
                                                    @endif                                                
