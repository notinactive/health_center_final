                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="gradeC" style="font-family: b koodak;">
                                                ...
                                                @if($product->cancel == '0' )
                                                <a href="#" class="btn btn-danger btn-sm btn-line" data-toggle="modal" data-target="#delete{{ $product->id }}">ثبت انصراف</a>
                                                @elseif($product->cancel == '1')
                                                
                                                @endif                              
                                                    
                                                <a href="<?=Url('client/process2/'.$product->id); ?>" class="btn btn-info btn-sm btn-line">مشاهده جزئیات</a>
                                                </td>
                                                    @if( $product->cancel == '0' )
