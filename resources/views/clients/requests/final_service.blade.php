...
@section('statistics')
	        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-right" style="font-family: b koodak;">لیست درخواست های خدمت نهایی شده</div>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="gradeC" style="font-family: b koodak;">
                                                ...
                                                @if($service->cancel == '0' )
                                                <a href="#" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#delete{{ $service->id }}">ثبت انصراف</a>
                                                @elseif($service->cancel == '1')
                                                
                                                @endif                              
                                                    
                                                <a href="<?=Url('client/final1/'.$service->id); ?>" class="btn btn-info btn-sm btn-line">مشاهده جزئیات</a>
                                                </td>
                                                    @if( $service->cancel == '0' )
