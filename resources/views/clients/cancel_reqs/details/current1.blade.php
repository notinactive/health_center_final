...
@section('statistics')
	        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-right" style="font-family: b koodak;">جزئیات درخواست خدمت انصرافی بلاتکلیف {{ $confirms->codepaygiry }}</div>
                                <div class="pull-left"><a href="{{ route('scancel_current') }}" class="btn btn-danger" style="font-family: b koodak; margin-top: 0px; margin-bottom: 3px;">بازگشت</a>
                                </div>
                            </div>
                                            ...
                                            @foreach($confirm1 as $confirm)
                                              <tr>
                                               ...
                                               @endif 
                                                ...
                                                <td style="font-family: b nazanin; text-align: center;">{!! getservname($confirm-> services_id) !!}</td>                    
                                              </tr>
                                              @endforeach
                                        </tbody>
                                    </table>
