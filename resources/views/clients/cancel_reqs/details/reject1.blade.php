...
@section('statistics')
	        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-right" style="font-family: b koodak;">جزئیات درخواست خدمت انصرافی رد شده {{ $confirms->codepaygiry }}</div>
                                <div class="pull-left"><a href="{{ route('scancel_reject') }}" class="btn btn-danger" style="font-family: b koodak; margin-top: 0px; margin-bottom: 3px;">بازگشت</a>
                                </div>
                            </div>
