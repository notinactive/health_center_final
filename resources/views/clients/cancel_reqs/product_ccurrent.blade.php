...
@section('statistics')
	        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-right" style="font-family: b koodak;">لیست درخواست های کالای انصرافی بلاتکلیف</div>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="gradeC" style="font-family: b koodak;">
                                                ...
                                                <a href="{{ route('ccurrent2' , ['id' => $cancel_confirm->id]) }}" class="btn btn-info btn-sm btn-line">مشاهده جزئیات</a>
                                                </td>
