...
@section('statistics')
            <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-right" style="font-family: b koodak;">لیست درخواست های خدمت انصرافی رد شده</div>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="gradeC" style="font-family: b koodak;">
                                                ...
                                                <a href="{{ route('creject1' , ['id' => $cancel_confirm->id]) }}" class="btn btn-info btn-sm btn-line">مشاهده جزئیات</a>
                                                </td>
