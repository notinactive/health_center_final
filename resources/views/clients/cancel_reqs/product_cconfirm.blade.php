...
@section('statistics')
	        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-right" style="font-family: b koodak;">لیست درخواست های کالای انصرافی تأیید شده</div>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="gradeC" style="font-family: b koodak;">
                                                ...
                                                <a href="{{ route('cconfirm2' , ['id' => $cancel_confirm->id]) }}" class="btn btn-info btn-sm btn-line">مشاهده جزئیات</a>
                                                </td>
                                                ...
                                                <td style="text-align: center;"> {{ jdate($cancel_confirm->cancel_date)->format('%B %d، %Y') }}</td>
                                                    ...
                                                    @elseif( $cancel_confirm->state_req == '2' )
                                                        <td style="color: black;text-align: center;">این درخواست ، مجوز تأیید کننده را دریافت نموده اما انصراف داده شده است  </td>
