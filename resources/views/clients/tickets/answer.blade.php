...
@section('statistics')
	        <div class="block">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="gradeC" style="font-family: b koodak;">
                                                ...
                                                <a href="#" class="btn btn-info btn-sm btn-line" data-toggle="modal" data-target="#delete{{ $answer->id }}">مشاهده جزئیات</a>
                                                </td>
                                                 
                                                 @if( $answer->olaviat == '0' )
                                                        <td style="color: red; text-align: center;">اولویتی انتخاب نشده است</td>
                                                 @elseif( $answer->olaviat == '1' )
                                                        <td style="color: black; text-align: center;"> اولویت کم</td>
                                                 @elseif( $answer->olaviat == '2' )
                                                        <td style="color: black; text-align: center;"> اولویت متوسط</td>
                                                 @elseif( $answer->olaviat == '3' )
                                                        <td style="color: black; text-align: center;"> اولویت زیاد</td>       
                                                 @endif 

                                                <td style="text-align: center;"> {{ $answer->title }} </td>
                                                <td style="text-align: center;"> {{ jdate($answer->created_at)->format('%B %d، %Y') }} </td>
                                                <td style="text-align: center;"> {{ $answer->codepaygiry }} </td>                                              
                                            </tr>
                                            @endforeach 
                                        </tbody>
                                    </table>
                    ...
                    <div class="row">
                        <div class="col-lg-12"> 
                          @foreach( $answers as $answer )                           
                            <div class="modal fade" id="delete{{ $answer->id }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                            <h4 class="modal-title" id="H2" style="font-family: b koodak;"><span style="color:blue; direction: rtl; text-align: justify;">"{{ $answer->codepaygiry }}" </span>جزئیات تیکت با کد پیگیری </h4>
                                        </div>
                                        <div class="modal-body">                    
                                          ...
                                          <span style="font-family: b koodak; direction: rtl; float: right; color: red"> تاریخ ثبت : {{ jdate($answer->created_at)->format('%B %d، %Y') }}</span>
                                          <br>
                                          <br>
                                          <hr>
                                           <span style="font-family: b koodak; direction: rtl; float: right;"> پاسخ تیکت :</span>
                                          <br>
                                           <span style="font-family: b nazanin; direction: rtl; text-align: justify;">{!! $answer->reply !!}</span> 
                                          <br>
                                          <br>
                                          <span style="font-family: b koodak; direction: rtl; float: right; color: green;"> تاریخ پاسخگویی : {{ jdate($answer->reply_date)->format('%B %d، %Y') }}</span>                                   
                                        </div>
