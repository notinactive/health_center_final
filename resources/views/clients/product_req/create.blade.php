...
@section('statistics')
	        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-right" style="font-family: b koodak;">ثبت درخواست کالای جدید</div>
                                <div class="pull-left"><a href="<?=Url('client/product_req'); ?>" class="btn btn-danger" style="font-family: b koodak; margin-top: 0px; margin-bottom: 3px;">بازگشت به لیست درخواست ها</a>
                                </div>
                            </div>
