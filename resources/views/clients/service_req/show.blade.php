...
@section('statistics')
	        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                ...
                                <div class="pull-left"><a href="<?=Url('client/service_req'); ?>" class="btn btn-danger" style="font-family: b koodak; margin-top: 0px; margin-bottom: 3px;">بازگشت</a>
                                </div>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        <thead>
                                            <tr style="font-family: b koodak;">
                                                ...
                                                <th style="text-align: center;"> خدمت انتخابی </th>             
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            @else
                                                <td style="text-align: center; font-family: b nazanin;"> {{ $service->description }}  </td>
                                            @endif    
                                                <td style="text-align: center;"> {{ $service->count }}  </td>
                                                <td style="text-align: center;"> {{ getservname($service->services_id) }} </td>                                              
                                            </tr>
                                            @endforeach 
                                        </tbody>
                                    </table>
...
{
  $products = Service::where('id' , $id)->first()['name'];
  return $products;
}
?>