...
@section('content')
   <div class="col-lg-12">
    <div class="row" >
        <h3> نمایش محتویات درخواست خدمت <a href="{{ route('srequest.index') }}" class="btn btn-danger btn-sm btn-line">بازگشت </a> </h3> 
    </div>
</div>
<hr/>
	        <div class="row">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                       ...
                       <tbody>
                            ...
                            @foreach( $services as $service )
                               ...
                               <td style="text-align: center;"> {{ getproname($service->services_id) }} </td>
